...
return {
    ...
    -- LSP (Neovim 0.11+ native config)
    {
        ...
        config = function()
            ...
            -- Explicitly enable LSP servers (required in Neovim 0.11+)
            ...
            vim.api.nvim_create_autocmd("LspAttach", {
                ...
                callback = function(ev)
                    ...
                    vim.keymap.set({ "n", "v" }, "<F4>", vim.lsp.buf.code_action, vim.tbl_extend("force", opts, { desc = "Code action" }))

                    -- Leader keymaps for LSP actions (more discoverable)
